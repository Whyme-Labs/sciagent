...
Agent tool:
  ...
  prompt: |
    ...
    [PASTE THE COMPLETE ASSEMBLED PAPER TEXT — all sections, all figures referenced, all tables, all supplementary text the authors intend reviewers to see]
...
After three independent reviews are validated, the orchestrator (or a dedicated editor-synthesis subagent using `prompts/paper-reviewer.md`) merges them:
